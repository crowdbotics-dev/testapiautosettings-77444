...
## Project Structure
    ...
    ├── testapiautosettings_77444  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_77444`
...
2. Clone this repo and `cd testapiautosettings_77444`
